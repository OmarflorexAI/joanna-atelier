...
# Johanna — Online Catalog / Portfolio

Catalog and portfolio for **Johanna**, a Dominican Republic designer of custom, hand-made
...
- `<Isologo />` — the mark locked to the "Johanna" wordmark. Used in the nav and footer.
...
Johanna with an asset she has no right to use.
...
Everything awaiting Johanna's real input is marked `TODO(johanna)` — grep for it.
